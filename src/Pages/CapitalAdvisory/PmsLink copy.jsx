...
import CommonSOPforreportingthedemiseofaninvestor from "../Assets/pdf/CommonSOPforreportingthedemiseofaninvestor.pdf";
      ...
      >
        ...
        <div className="md:flex justify-center items-center md:gap-6 gap-0 md:mx-40 lg:mx-20 mx-2 px-0">
          ...
          >
            ...
            <div>
              <a
                href={CommonSOPforreportingthedemiseofaninvestor}
                className="hover:underline"
              >
                <div className="flex justify-end gap-2 text-blue-900">
                  <p>Download</p>
