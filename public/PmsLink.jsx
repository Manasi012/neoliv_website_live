    ...
    <>
      ...
      >
        ...
        <div className="md:mx-40 lg:mx-20 mx-2 px-0 text-left">
          <h2 className="pb-9 pt-2 font-bold text-xl text-center text-blue-950">Alternative Investment Fund & Co- Portfolio Management Services Investor Information</h2>
        ...
        <div className="text-xl text-left font-medium  md:mx-40 lg:mx-20 mx-2 px-0 md:pt-0 pt-8">
          ...
          ODR Portal could be accessed, if unsatisfied with the response. Your attention is drawn to the SEBI circular no. <a href={SEBICircularonODR} className="text-blue-900 underline">SEBI/HO/OIAE/OIAE_IAD-3/P/CIR/2023/195</a> dated December 28, 2023, on “Online Resolution of Disputes in the Indian Securities Market”. A common Online Dispute Resolution Portal (“ODR Portal”) which harnesses conciliation and online arbitration for resolution of disputes arising in the Indian Securities Market has been established. ODR Portal can be accessed via the following link <a className="text-blue-900 underline" href="https://smartodr.in/">https://smartodr.in/</a></p>
        </div>
        ...
        <div className="md:flex justify-center items-center md:gap-6 gap-0 md:mx-40 lg:mx-20 mx-2 px-0">
          ...
          >
            ...
            {/* <Link
          to="/feescalculation" target="_blank"  onClick={() => sessionStorage.setItem("pms_opened", "true")}
          className="ps-1 hover:underline cursor-pointer"
        > */}
       <a
  href={`https://docs.google.com/gview?url=${encodeURIComponent(FinalRevisedNeolivPMSillustration280125)}&embedded=true`}
  target="_blank"
  rel="noopener noreferrer"
>
  <div className="flex justify-end gap-2 text-blue-900 -mt-6">
    <p>Download</p>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
    ...
    >
      ...
      />
        ...
        {/* </Link> */}
            ...
            <div className="bg-transparent md:h-[8rem] box_height md:p-2 p-4  h-auto py-4 md:w-full rounded-lg md:my-2 my-4"
            data-aos="fade-down"
            data-aos-delay="500"
          ...
          >
            ...
            <div>
              ...
              <NavLink to="/feescalculation" target="_blank" className="i md:block hidden" onClick={() => sessionStorage.setItem("fees_opened", "true")}
              >
                 <a >
                <div className="flex justify-end gap-2 text-blue-900">
                  <p>Download</p>
